...
public class FrequencyTable {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> intList = new ArrayList<>(Collections.nCopies(6,0));
        ...
        for (int i = 0; i<6000; i++) {
            ...
            intList.set(diceValue, intList.get(diceValue) + 1); //add the value to the correct ArrayList element.
        }

        for (int i=1; i<7; i++) {
            System.out.println(i + ": " + intList.get(i-1));
        }
    }
}
